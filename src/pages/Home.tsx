    ...
    <div className="w-full overflow-x-hidden">
      ...
      <section className="relative min-h-[100dvh] flex items-center justify-center pt-20 overflow-hidden bg-background">
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute top-20 right-0 w-64 h-64 md:w-96 md:h-96 bg-gradient-to-br from-primary/20 to-transparent rounded-full blur-3xl opacity-40 animate-pulse" />
          <div className="absolute bottom-0 left-0 w-64 h-64 md:w-96 md:h-96 bg-gradient-to-tr from-secondary/20 to-transparent rounded-full blur-3xl opacity-40 animate-pulse" />
          <div className="absolute top-1/2 right-1/4 w-48 h-48 md:w-64 md:h-64 bg-gradient-to-br from-accent/15 to-transparent rounded-full blur-3xl opacity-30" />
        ...
        <div className="container relative z-10 mx-auto px-6 md:px-12 flex flex-col items-center text-center">
          ...
          >
            {/* Badge premium */}
            <motion.div variants={fadeUp} className="mb-6 inline-flex items-center space-x-2 px-4 py-2 rounded-full border border-primary/40 bg-gradient-to-r from-primary/10 via-accent/5 to-secondary/10 backdrop-blur-md hover:border-primary/70 transition-all duration-300 hover:shadow-lg hover:shadow-primary/20 max-w-full">
              <Zap size={14} className="text-primary shrink-0" />
              <span className="text-[10px] md:text-xs font-medium tracking-widest text-primary uppercase truncate">Écosystème digital premium</span>
            </motion.div>
            
            {/* Hero title avec gradient */}
            <motion.h1 variants={fadeUp} className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-serif font-bold leading-[1.1] mb-8 text-foreground break-words">
            ...
            {/* Subtitle */}
            <motion.p variants={fadeUp} className="text-base md:text-xl text-muted-foreground mb-12 max-w-2xl mx-auto font-light leading-relaxed">
              Une alliance unique entre une agence de transformation digitale d'élite et une plateforme intellectuelle de haut vol.
            </motion.p>
            
            {/* CTA Cards */}
            <motion.div variants={fadeUp} className="flex flex-col sm:flex-row items-center justify-center gap-6 w-full max-w-md sm:max-w-none mx-auto">
      ...
      <section className="py-20 md:py-32 bg-background relative overflow-hidden">
        <div className="absolute inset-0 z-0">
          <div className="absolute top-1/2 right-0 w-64 h-64 md:w-96 md:h-96 bg-gradient-to-bl from-accent/10 to-transparent rounded-full blur-3xl opacity-30" />
          <div className="absolute bottom-0 left-1/4 w-64 h-64 md:w-80 md:h-80 bg-gradient-to-tr from-primary/5 to-transparent rounded-full blur-3xl opacity-20" />
        </div>
        <div className="container relative z-10 mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <motion.div 
              ...
              variants={staggerContainer}
            >
              <motion.h2 variants={fadeUp} className="text-3xl md:text-5xl font-serif font-bold mb-6 text-foreground leading-tight">
              ...
              <motion.p variants={fadeUp} className="text-muted-foreground text-base md:text-lg mb-6 leading-relaxed">
              ...
              <motion.p variants={fadeUp} className="text-muted-foreground text-base md:text-lg mb-8 leading-relaxed">
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8 bg-gradient-to-t from-background via-background/90 to-transparent z-30">
                <div className="flex items-center gap-4">
                  <div className="text-center">
                    <span className="block text-2xl md:text-3xl font-serif font-bold text-primary">150+</span>
                    <span className="text-[10px] md:text-xs uppercase tracking-wider text-muted-foreground font-medium">Projets livrés</span>
                  </div>
                  <div className="w-[2px] h-10 md:h-12 bg-gradient-to-b from-primary via-accent to-secondary opacity-60" />
                  <div className="text-center">
                    <span className="block text-2xl md:text-3xl font-serif font-bold text-secondary">40+</span>
                    <span className="text-[10px] md:text-xs uppercase tracking-wider text-muted-foreground font-medium">Articles publiés</span>
                  </div>
                </div>
              </div>
            </motion.div>
